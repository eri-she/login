...
$error = false;
// declare variables for each field and error messages.
$fname = $lname = $date_of_birth = $email = $pass = $picture = "";
$fnameError = $lnameError = $dateError = $emailError = $passError = $picError = "";
// isset checks if the signup button has been clicked .
if (isset($_POST['btn-signup'])) 
{
// cleans the format entered.
...
// we check that the fields are not empty otherwise error messages are updated.
    ...
    if (empty($fname) || empty($lname)) {
        ...
        // preg_match checks that the name has only letters.
...
// if there are no errors we create a new record in our database.
    if (!$error) {
        $query = "INSERT INTO users(first_name, last_name, password, date_of_birt, email, picture) 
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4 d-flex align-items-center">
                                    <div class="form-outline datepicker w-100">
                                        <input class='form-control' type="date" name="date_of_birth" placeholder="birth date" value="<?php echo $date_of_birth ?>" />
